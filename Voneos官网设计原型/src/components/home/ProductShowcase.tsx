          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 px-6 pb-6 z-30 text-white flex flex-col justify-end bg-gradient-to-t from-black/40 to-transparent">
                <p className="product-type-text text-white/90 tracking-wide font-normal">{product.type}</p>
                <h5 className="product-name-text font-bold tracking-wide">{product.name}</h5>
